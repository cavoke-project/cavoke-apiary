...
public:
    ...
    */
    void changeRole(const QString &session_id, const qint32 &new_role);
    ...
    * @param[in]  game_id QString [required]
    */
    void createSession(const QString &game_id);
    ...
    * @param[in]  session_id QString [required]
    */
    void getUpdate(const QString &session_id);
    ...
    */
    void joinSession(const QString &session_id, const ::OpenAPI::OptionalParam<qint32> &position = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  session_id QString [required]
    */
    void leaveSession(const QString &session_id);
    ...
    */
    void profileChangeNamePost(const QString &new_name);


    void profileGetMeGet();

    /**
    * @param[in]  display_name QString [required]
    */
    void roomCreate(const QString &display_name);

    /**
    * @param[in]  room_id QString [required]
    */
    void roomInfo(const QString &room_id);

    /**
    * @param[in]  invite_code QString [required]
    */
    void roomInfoByCode(const QString &invite_code);

    /**
    * @param[in]  invite_code QString [required]
    */
    void roomJoin(const QString &invite_code);

    /**
    * @param[in]  room_id QString [required]
    */
    void roomLeave(const QString &room_id);

    /**
    * @param[in]  room_id QString [required]
    * @param[in]  game_id QString [required]
    */
    void roomNewSession(const QString &room_id, const QString &game_id);

    /**
    * @param[in]  session_id QString [required]
    * @param[in]  oai_game_move OAIGameMove [optional]
    */
    void sendMove(const QString &session_id, const ::OpenAPI::OptionalParam<OAIGameMove> &oai_game_move = ::OpenAPI::OptionalParam<OAIGameMove>());

    /**
    * @param[in]  session_id QString [required]
    */
    void sessionInfo(const QString &session_id);

    /**
    * @param[in]  session_id QString [required]
    */
    void startSession(const QString &session_id);
    ...
    */
    ...
    void userAuthStatistics();

    /**
    * @param[in]  game_id QString [required]
    */
    void userGameAuthStatistics(const QString &game_id);
    ...
    */
    void usersGetUserGet(const QString &req_user_id);

    /**
    * @param[in]  session_id QString [required]
    */
    void validateSession(const QString &session_id);
